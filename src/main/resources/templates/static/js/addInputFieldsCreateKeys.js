...
function addInput() {
    if (x < 10) {
        var str = '        <div class="container">\n' +
            ...
            '                </div>\n' +
            '                <div class="col-sm-4">\n' +
            '                    <input type="text" class="form-control form-control-sm" name="secondName" id = "secondName" >\n' +
            '                </div>\n' +
            '            </div>\n' +
            '            <div class="form-group row">\n' +
            '                <div class="col-sm-2">\n' +
            ...
            '                </div>\n' +
            '                <div class="col-sm-4">\n' +
            '                    <input type="text" class="form-control form-control-sm" name="organ" id = "organ" >\n' +
            '                </div>\n' +
            '            </div>\n' +
            '            <div class="form-group row">\n' +
            '                <div class="col-sm-2">\n' +
