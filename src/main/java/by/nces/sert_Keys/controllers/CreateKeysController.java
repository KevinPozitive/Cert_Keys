...
public class CreateKeysController {
    ...
    public String CertSetAdd(@RequestParam String country, @RequestParam String nameUC,
                             ...
                             @RequestParam String position, @RequestParam String reason) throws ParseException {
